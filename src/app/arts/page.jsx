...
export default async function ArtsPage() {
    ...
    try {
        const prismicArticles = await client.getAllByType("article", {
            filters: [
                filter.at("my.article.category", "Arts")
            ],
            orderings: [
        ...
        articles = prismicArticles.map((article) => ({
            ...
            category: article.data.category || "Arts",
        ...
        console.error("Error fetching arts articles:", error);
    }
        ...
        <>
            ...
            <main className="max-w-[1600px] mx-auto px-8 py-16">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900">Arts & Culture</h1>
                </div>
                <p className="text-gray-600 mb-10 text-lg">Museums, galleries, theater, and cultural events</p>
                ...
                {articles.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-lg">
                        <p className="text-gray-500 text-lg">No arts articles found.</p>
                    </div>
                )}
            </main>
            <Footer />
