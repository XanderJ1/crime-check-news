...
export default async function EntertainmentPage() {
    ...
    try {
        const prismicArticles = await client.getAllByType("article", {
            filters: [
                filter.at("my.article.category", "Entertainment")
            ],
            orderings: [
        ...
        articles = prismicArticles.map((article) => ({
            ...
            category: article.data.category || "Entertainment",
        ...
        <>
            ...
            <main className="max-w-[1600px] mx-auto px-8 py-16">
                <div className="flex items-center gap-3 mb-8">
                    <div className="w-1.5 h-12 bg-purple-600 rounded-full"></div>
                    <h1 className="text-4xl font-bold text-gray-900">Entertainment</h1>
                </div>
                <p className="text-gray-600 mb-10 text-lg">Movies, music, celebrities, and pop culture</p>
                ...
                {articles.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-lg">
                        <p className="text-gray-500 text-lg">No entertainment articles found.</p>
                    </div>
                )}
            </main>
            <Footer />
