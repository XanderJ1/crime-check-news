...
export default async function BusinessPage() {
    ...
    try {
        const prismicArticles = await client.getAllByType("article", {
            filters: [
                filter.at("my.article.category", "Business")
            ],
            orderings: [
        ...
        articles = prismicArticles.map((article) => ({
            ...
            category: article.data.category || "Business",
    ...
    return (
        <>
            ...
            <main className="max-w-7xl mx-auto px-8 py-16">
                ...
                <p className="text-gray-600 mb-10 text-lg">Markets, economy, and corporate news that matters</p>
                ...
                {articles.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-lg">
                        <p className="text-gray-500 text-lg">No business articles found.</p>
                    </div>
                )}
            </main>
            <Footer />
