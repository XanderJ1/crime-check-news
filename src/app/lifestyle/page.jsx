...
export default async function LifestylePage() {
    ...
    try {
        const prismicArticles = await client.getAllByType("article", {
            filters: [
                filter.at("my.article.category", "Lifestyle")
            ],
            orderings: [
        ...
        articles = prismicArticles.map((article) => ({
            ...
            category: article.data.category || "Lifestyle",
        ...
        <>
            ...
            <main className="max-w-[1600px] mx-auto px-8 py-16">
                <div className="flex items-center gap-3 mb-8">
                    <div className="w-1.5 h-12 bg-pink-600 rounded-full"></div>
                    <h1 className="text-4xl font-bold text-gray-900">Lifestyle</h1>
                </div>
                <p className="text-gray-600 mb-10 text-lg">Health, wellness, fashion, and living your best life</p>
                ...
                {articles.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-lg">
                        <p className="text-gray-500 text-lg">No lifestyle articles found.</p>
                    </div>
                )}
            </main>
            <Footer />
